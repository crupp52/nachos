...
class MovieInfoProvider {
    companion object {
        ...
        private fun initMovieList(): MutableList<Movie> {
            ...
            movieList.add(Movie(5, "Batman 3", "2019"))
            movieList.add(Movie(6, "Fast and Furious 22", "2030"))
            movieList.add(Movie(7, "Frozen 45", "2019"))
            movieList.add(Movie(8, "Find Nemo 654", "2003"))
